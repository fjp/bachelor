...
Light red areas show the visited nodes, which is a new feature implemented in the lambda expression
used in `visualizer::write` function. 
The island map results for all three implementations are stored in [doc/images/test/](doc/images/test/).
